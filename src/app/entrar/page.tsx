  ...
  return (
    <main className="flex flex-col min-h-screen bg-zinc-900 px-6 pt-safe-top">
      ...
      <div className="flex items-center pt-6 pb-8">
        ...
        <h1 className="text-xl font-semibold text-white ml-3">Entrar</h1>
      </div>
      ...
      <form className="flex flex-col gap-4">
        ...
        <div className="flex justify-end">
          <Link href="/recuperar-senha" className="text-amber-500 text-sm">
            Esqueceu a senha?
          </Link>
        </div>
      ...
      <div className="mt-8 text-center">
        ...
        <Link href="/cadastrar" className="text-amber-500 text-sm font-medium">
          Cadastre-se
        </Link>
      </div>
    </main>
